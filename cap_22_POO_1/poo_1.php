...
<body>
    ...
    class Coche
    {
        ...
        function Coche()
        {
            ...
            //   ->   con este simbolo referencio una propiedad o un metodo de la clase
        ...
        //estas son las funcionalidades las de abajo
        function arrancar()
        {
    ...
    $renault = new Coche();        //objeto o instancia todas la que quiera
    $mazda = new Coche();
    $seat = new Coche();
